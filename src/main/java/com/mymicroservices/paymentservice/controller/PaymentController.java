package com.mymicroservices.paymentservice.controller;
...
public class PaymentController {
    ...
    public ResponseEntity<PaymentResponseDto> createPayment(@Valid @RequestBody PaymentRequestDto paymentDto) {
        log.info("Request to add a new Payment record: {}", paymentDto);
    ...
    public ResponseEntity<?> getPaymentById (@PathVariable("id") String id) {
        ...
        PaymentResponseDto paymentDto = paymentService.getPaymentById(id);
    ...
    public ResponseEntity<?> updatePayment (@PathVariable("id") String id,
        ...
        PaymentResponseDto updatedPayment = paymentService.updatePayment(id, dtoDetails);
    ...
    public ResponseEntity<?> deletePayment (@PathVariable("id") String id){
        ...
        PaymentResponseDto deletedPaymentDto = paymentService.deletePaymentById(id);
    ...
    public ResponseEntity<List<PaymentResponseDto>> getPaymentsbyOrder(@PathVariable String orderId) {
        ...
        List<PaymentResponseDto> paymentDtos = paymentService.getPaymentsByOrderId(orderId);
    ...
    public ResponseEntity<List<PaymentResponseDto>> getPaymentsbyUser(@PathVariable String userId) {
        ...
        List<PaymentResponseDto> paymentDtos = paymentService.getPaymentsByUserId(userId);
        return ResponseEntity.ok(paymentDtos);
    }

    @GetMapping("/statuses")
    public ResponseEntity<List<PaymentResponseDto>> getPaymentsbyStatuses(@RequestParam List<String> statuses) {
        log.info("Request to get payment records by statuses: {}", statuses);
        List<PaymentResponseDto> paymentDtos = paymentService.getPaymentsByStatuses(statuses);
        return ResponseEntity.ok(paymentDtos);
    }
